  ...
  return (
    <>
      <div className="flex justify-between px-10 py-5 sm:px-20 md:px-30 lg:px-40">
        <div>
          <img
            src="/assets/images/bhive_logo.svg"
            alt="logo"
        ...
        <div className="p-1.5 sm:p-2 lg:2.5 h-full  border-2 border-[#F2B304]">
          <img
            src="/assets/images/telephone_icon.svg"
            alt="logo"
            className="w-3 lg:w-4"
          />
        </div>
      </div>
      <div className="w-full min-w-[80vw] px-10 sm:px-20 md:px-30 lg:px-40 md:flex md:flex-row-reverse md:items-center md:justify-between md:bg-[url('/assets/images/header/header-background.svg')] ">
        <div className="w-full h-full md:w-1/3 flex justify-center ">
          ...
          >
            <source
              src="/assets/images/header/co-working-video.mp4"
              type="video/mp4"
            />
          </video>
        </div>
